"""Grouped boxplots of listing price by borough, clustered by room type."""
...
def main():
    ...
    offsets = [(-1) * BOX_WIDTH, 0, BOX_WIDTH]
    ...
    for room_type, offset in zip(TYPE_ORDER, offsets):
        ...
        box = ax.boxplot(
            ...
            flierprops={"markersize": 2.5, "markerfacecolor": "gray", "markeredgecolor": "none", "alpha": 0.35},
        )

        for patch in box["boxes"]:
            patch.set_facecolor(TYPE_COLORS[room_type])
    ...
    fig.savefig(SCRIPT_DIR / "boxplot-type.png", dpi=150)
    plt.show()
